...
**Pattern**: Implements [[patterns/auditor-pattern]]
...
This skill follows the [[patterns/auditor-pattern|Audit Pattern]] based on ISO 19011:2018 principles:
...
6. Set up audit tracking (`.claude/auditors/` directory, README, table)
...
**Outputs**:
- Audit log (`.claude/auditors/auditor-log-YYYY-MM-DD.md`)
...
**Pattern**:
- [[patterns/auditor-pattern]] - Generic pattern this implements (ISO 19011-based)
...
- [[skills/auditoror-checklist]] - Skills quality checklist
