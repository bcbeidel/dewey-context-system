...
3. Apply [[skills/auditoror-checklist]] to flagged skills
4. Document in `.claude/auditors/skills-audit-YYYY-MM-DD.md`
...
6. **Set up tracking** (`.claude/auditors/` directory, tracking table)
