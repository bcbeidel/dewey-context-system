...
**Read pattern for guidance**: [[context/workflows/patterns/auditor-pattern#component-2-quality-criteria]]
...
# Generate report
echo "## Context Audit - $(date +%Y-%m-%d)" > .claude/auditors/context-audit-$(date +%Y-%m-%d).md
```
...
**Use skill-audit-checklist.md as template**: [[skills/auditoror-checklist]]
...
```bash
mkdir -p .claude/auditors
```

**Create README**: `.claude/auditors/[artifact-type]-README.md`
...
- [ ] Audit tracking set up (.claude/auditors/)
- [ ] Baseline audit run
...
- **Checklist**: [[skills/auditoror-checklist]]
...
- [[patterns/auditor-pattern]] - Generic audit pattern (ISO 19011-based)
- [[skills/auditoror-checklist]] - Example checklist (skills)
