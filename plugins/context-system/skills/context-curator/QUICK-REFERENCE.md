# Context Curator - Quick Reference

## When to Use

Use `/context-curator` to periodically extract and update context from:
...
- [[context-system/context-governance]] - How to maintain context
- [[extras/templates/Template, Context]] - Context note template
- [[extras/templates/Template, Decision]] - Decision log template
