...
```
.claude/audits/audit-log-YYYY-MM-DD.md
```
...
**Example**:
```bash
Read: context/skills/audit-checklist.md
```
...
**Source**: [[patterns/audit-pattern#component-6-prioritization-framework]]
...
- [ ] Audit log created (`.claude/audits/audit-log-YYYY-MM-DD.md`)
